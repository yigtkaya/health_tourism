...
class ValidationContainer extends StatefulWidget {
  ...
  const ValidationContainer({Key? key, required this.isPasswordLongEnough,
  required this.isPasswordContainsNumber, required this.isPasswordContainsUpperCase}) : super(key: key);
          ...
          children: [
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: widget.isPasswordLongEnough ?  Colors.green : Colors.transparent,
                  border: widget.isPasswordLongEnough ? Border.all(color: Colors.transparent) :
        ...
        Row(
          children: [
            AnimatedContainer(
              ...
              height: 20,
              decoration: BoxDecoration(
                  color: widget.isPasswordContainsNumber ?  Colors.green : Colors.transparent,
                  border: widget.isPasswordContainsNumber ? Border.all(color: Colors.transparent) :
                  Border.all(color: Colors.grey.shade400),
                  borderRadius: BorderRadius.circular(50)
              ),
              child: const Center(child: Icon(Icons.check, color: Colors.white, size: 15,),),
        ...
        Row(
          children: [
            AnimatedContainer(
              ...
              height: 20,
              decoration: BoxDecoration(
                  color: widget.isPasswordContainsUpperCase ?  Colors.green : Colors.transparent,
                  border: widget.isPasswordContainsUpperCase ? Border.all(color: Colors.transparent) :
                  Border.all(color: Colors.grey.shade400),
                  borderRadius: BorderRadius.circular(50)
              ),
              child: const Center(child: Icon(Icons.check, color: Colors.white, size: 15,),),
